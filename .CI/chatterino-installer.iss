...
#define MyAppName "Limerino"
; Keep in sync with project(VERSION) in the root CMakeLists.txt (7.x.x lineage).
#define MyAppVersion "7.5.5"
#define MyAppPublisher "Limerino"
#define MyAppURL "https://github.com/lagx/Limerino"
